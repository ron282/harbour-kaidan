...
#if defined(SFOS)
#include "../3rdparty/QtMultimedia/QVideoFrameToQImage.h"
#endif
...
#if defined(SFOS)
	return m_filter->m_videoFrameMirrored ? QVideoFrame(QVideoFrameToQImage(*input).mirrored(true, false)) : *input;
#else
