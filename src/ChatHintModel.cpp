...
#if defined(SFOS)
bool ChatHintButton::operator==(const ChatHintButton &other) const
{
    return type == other.type &&
           text == other.text;
}

bool ChatHintModel::ChatHint::operator==(const ChatHintModel::ChatHint &other) const
{
    return text == other.text &&
           buttons == other.buttons &&
           loading == other.loading &&
           loadingDescription == other.loadingDescription;
}
#endif
...
#if defined(SFOS)
    connect(Kaidan::instance(), &Kaidan::connectionErrorChanged, this, static_cast<void (ChatHintModel::*)()>(&ChatHintModel::handleConnectionErrorChanged));
#else
