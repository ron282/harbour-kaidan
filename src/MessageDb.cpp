...
#if defined(SFOS)
		rec.append(createSqlField(QStringLiteral("timestamp"), newMsg.timestamp.toString(Qt::ISODate).insert(19, newMsg.timestamp.toString(".zzz"))));
#else
...
#if defined(SFOS)
            { u":timestamp", message.timestamp.toString(Qt::ISODate).insert(19, message.timestamp.toString(".zzz")) },
#else
